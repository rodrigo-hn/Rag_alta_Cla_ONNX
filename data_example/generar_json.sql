-- =====================================================
-- GENERAR JSON - VERSIÓN FINAL CORREGIDA v2
-- Soluciona el error ORA-01722 usando TO_NUMBER con DEFAULT
-- =====================================================
...
FROM (
    WITH datos_pruebas AS (
        SELECT
            ...
            -- Conversión segura usando DEFAULT ON CONVERSION ERROR (Oracle 12.2+)
            TO_NUMBER(
